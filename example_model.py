...
@log_inference
def inference(img: Image.Image, input: str, float_value1: float, float_value2: float, str_value: str):
    return ImageOps.invert(img), f"Input: {input}, float_value1: {float_value1}, float_value2: {float_value2}, str_value: {str_value}"
